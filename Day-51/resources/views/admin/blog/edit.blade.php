...
{{--                                    @endforeach--}}
{{--                                </select>--}}
                                <input type="text" name="category_id" id="" value="{{$blog->category_id}}">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input1" class="col-sm-3 col-form-label">Blog Title</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="main_title" id="horizontal-firstname-input1" value="{{$blog->main_title}}"/>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input2" class="col-sm-3 col-form-label">Blog Sub Title</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="sub_title" id="horizontal-firstname-input2" value="{{$blog->sub_title}}" />
                            </div>
                        </div>
                        <div class="form-group row mb-4">
